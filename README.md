...
- Monitor customer behaviour monthly.
- Measure customer growth over time.
- Provide historically accurate KPIs.
...
The SQL database enabled the creation of a helper table that was later used to generate monthly customer snapshots. These snapshots became the foundation for all customer analytics.
...
Because Monetary Value and  Frequency are cumulative metrics, summing multiple monthly snapshots would produce incorrect results.
...
Helper table generated in SQL formed the basis for monthly customer snapshots, while Python produced the Customer Value classifications later consumed by Power BI.
...
This project demonstrates how combining **RF Customer Segmentation**, **Customer Value Analysis**, and **monthly-based reporting** can provide a more meaningful understanding of customer behaviour than traditional customer segmentation alone.
